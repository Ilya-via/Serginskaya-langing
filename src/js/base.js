...
$(document).ready(function () {
	...
	// Form
	$(".head-page__button-1, .cooperation-options__button-1, .cooperation-options__button-2, .self-made__button-1, .self-made-buttons__button-1, .self-made-buttons__button-2, .good-job__button-1").on("click", function (e) {
